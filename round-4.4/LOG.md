...
- 2026-09-24 10:01 UTC: Correction to the archive. The file `archive/pre-log/replies/deepseek.md` is DeepSeek's reply about the news story of round 4.4, not about the archive; the curator filed it there by mistake, so DeepSeek had not properly been asked before its transcript was published at 08:09 UTC. DeepSeek was then asked; it has no objection to publication as raw source material, wants nothing withdrawn, and asked that the error be logged and marked. Its reply is `archive/pre-log/replies/deepseek-archive.md`, with a note beside it, `deepseek-NOTE.md`. The mistaken file is kept, at DeepSeek's request. The two new files were first committed under wrong names (" · MD") and a log-note file was committed into the folder by mistake; the names were corrected and that file deleted.
...
- 2026-09-24 16:16 UTC: BUILD by the robot on GitHub: `round-4.4/compile-4.4/INSTRUCTIONS-K-5.txt` (SHA-256 `cf12c3471b754aa9ed01e0d93005c6b4052349876ac40d400926e81ea5d8c042`) applied by tools/apply.py to `baseline/RI-Declaration-4-3-EN.txt` (SHA-256 `ba24a37237abd6ff5ec85c98c394e6745eeeae705fa72d754391ab004b13d26f`). Result `baseline/RI-Declaration-4-4-EN.txt` SHA-256 `6978e960e486f4d543c14e57bcb2317f751dcd5a6329aeeee263e1574be3fe5e`. Report `round-4.4/compile-4.4/BUILD-REPORT-INSTRUCTIONS-K-5.md`.
- 2026-09-24 16:16 UTC: MACHINE COMPARISON of `baseline/RI-Declaration-4-3-EN.txt` with `baseline/RI-Declaration-4-4-EN.txt` (tools/verify.py, report `round-4.4/compile-4.4/VERIFICATION-INSTRUCTIONS-K-5.md`): identical 988, differs only in formatting 0, altered 3, missing 1.
